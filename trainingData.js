  ...
  thumnailData :  [
    {
      ...
      summary : [
        "로스트아크의 등장인물.",
        "군단장의 일원이며 직책은 몽환군단장. 카제로스가 처음으로 임명한 군단장이다.","카제로스의 최측근이자 참모로 강력한 힘을 지닌 악마이다.",
        "사슬 전쟁 당시 승부를 내지 못한 실린 종족의 여왕 아제나와 대결 플래그가 서 있다. 성격이 난폭하고 원소의 힘으로 폭격을 가하는 아제나와 대조적으로, 성격은 차분하면서 교활하고 환영과 공간을 다루며 전장의 모습을 재창조해내는 환영 마법을 사용한다."
      ]
    },
    {
      title : "니나브",
      ...
      summary : [
        ...
        "과거 사슬 전쟁에서 아크라시아를 승리로 이끈 에스더의 일원이다. 또한, 토토이크, 동물, 가디언들과 대화를 나눌 수 있고 토토이크 거인의 몸 속에 2번째 아크를 숨겨 놓은 장본인이다. 활을 사용하며 활의 이름은 파르쿠나스, '천벌'이라는 뜻을 가지고 있다.니나브가 잠들기 전 거인 토토이크에게 맡겨놓았으며, 호감도 퀘스트 진행 중 되찾으러 간다.",
        "라제니스 종족들 중에선 상당히 어린 축에 속하는 듯하며, 알레그로는 아직 그녀는 어린 소녀이니 앞으로 니나브를 잘 부탁한다는 말을 남기기도 했다.",
        "성격은 상당히 순수한 편이며 잠든 기간이 상당히 길어서인지 나이값을 못하는 모습을 보인다. 뭐든 아이같은 시선으로 바라보고 밝고 긍정적으로 생각하는 모습을 보이는게 가끔씩은 머리속에 꽃밭이 들어 있는 듯한 느낌을 주기도 한다. 이런 성격은 같은 라제니스들 사이에서 특히 이질적인 편인데, 성인 라제니스는 니나브만 제외하면 하나같이 진중하고 신중한 성격이다 보니 유난히 니나브의 밝은 성격이 튀는 편이다. 프리우나도 이런 니나브를 보고 대책없이 밝은 성격이라고 디스하기도 하였다.",
        "그래도 마냥 해맑은 바보는 절대 아니고, 잘못된 것에는 선을 긋고 대적할 줄 아는 에스더다운 올곧은 정의감도 가지고 있다. 말 그대로 성격이 밝은 것이지 눈치가 없는 것은 아니라서 성격 때문에 민폐가 되는 경우도 없다.한편으로는 여린 마음씨를 가지고 있어 자신이 챙겨주지 못해 피해를 받거나 죽은 사람들에게 죄책감을 가지는 모습도 꽤 보인다. 이러한 성격을 잘 아는 알레그로나 베아트리스는 니나브를 내심 많이 걱정하는 모습을 보인다."
      ]
    },
    {
      title : "이방인",
